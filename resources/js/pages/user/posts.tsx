...
export default function PostsPage({ posts = defaultPosts, categories = [], filters = defaultFilters }: PostsPageProps) {
    ...
    const handleSortChange = (value: string) => {
        setSortBy(value);
        router.get(route('user.posts.index'), { search, category: selectedCategory, sort: value }, { preserveState: true, preserveScroll: true });
    };
                        ...
                        posts.data.map((post) => (
                            ...
                            >
                                <div className="p-6">
                                    ...
                                    <Button variant="outline" className="w-full" onClick={() => router.visit(route('user.posts.show', post.id))}>
                                        Read More
                                    </Button>
                                </div>
                            </div>
